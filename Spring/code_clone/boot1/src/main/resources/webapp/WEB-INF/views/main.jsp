...
<body style="text-align:center">
    ...
    <h3>컨트롤러(Controller) - return 방식 </h3>
    <a href="template.do?na=호랑이">템플릿(template)</a><br/>
    <a href="string.do?na=사과">문자열(String)</a><br>
    <a href="json.do?title=스프링&price=30000">제이슨(JSON)</a>

    <h3>컨트롤러(Controller): 다양한 Give&Take</h3>
    <a href="test">m00</a>
    ...
    <a href="test/param8?subject=데이트&cdate=2024/03/13 10:33:30">m11</a>
